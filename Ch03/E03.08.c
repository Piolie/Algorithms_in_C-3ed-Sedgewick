...
floating-point numbers) from standard input, and finds whether they are
collinear, using the added collinear() function.
...
diff = 10000000272564224.000000; max = 20000000545128448.000000; diff/max = 0.500000
Collinear? FALSE
