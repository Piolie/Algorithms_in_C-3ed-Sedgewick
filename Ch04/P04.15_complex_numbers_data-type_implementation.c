...
------------------------------------------------------------------------
                              PROGRAM 4.15
                Complex-numbers data-type implementation
------------------------------------------------------------------------
These function implementations for the complex numbers data type are
straightforward. However, we would prefer not to separate them from the
definition of the Complex type, which is defined in the interface for
