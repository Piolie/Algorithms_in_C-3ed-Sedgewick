...
together with the interface of Program 4.6, packages the code in a form
that makes it convenient for use in other applications. The
implementation uses a local function find.
--------------------------------------------------------------------- */
