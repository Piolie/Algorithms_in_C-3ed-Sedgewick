...
------------------------------------------------------------------------
This program uses an additional array, height[], for the purpose of
tracking, for each object with id[i] == i, the height of the associated
tree, so that the union operation can link the shorter of the two
specified trees to the taller, thus preventing the growth of long paths
in the trees.
...
I'm skipping the empirical studies.
--------------------------------------------------------------------- */
