...
/* ---------------------------------------------------------------------
The book states:
    In the case that N/2 represents floor[N/2], we have a simple
    solution: C_N is the number of bits in the binary representation of
    N, and that number is floor[lg N] + 1, by definition.
...
Figure 2.6 clarifies the intuitive part:
   ...
   15    1111        111            4
    ...
    floor[N/2] by removing the rightmost bit. That is, the number of
    bits in the binary representation of N is 1 greater than the number
    of bits in the binary representation of floor[N/2]. Therefore,
    floor[lg N] + 1, the number of bits in the binary representation of
    N, is the solution to Formula 2.2 for the case that N/2 is
    interpreted as floor[N/2].
